// Package cli builds the csdn command tree on top of the csdn library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: csdn.DefaultConfig()}

	root := &cobra.Command{
		Use:   "csdn",
		Short: "Browse CSDN Chinese developer articles",
		Long: `csdn reads CSDN through its public APIs.
