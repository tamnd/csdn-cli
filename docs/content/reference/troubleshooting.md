...
Most of these come down to network reality or how csdn-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

csdn-cli rate-limits like any public site. csdn already paces
...
Where a surface is gated, csdn reads a cookie or token you supply
