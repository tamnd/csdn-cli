---
title: "v0.1.0"
description: "Initial release of csdn-cli on the any-cli/kit framework."
weight: 10
---

The first release, built on the [any-cli/kit](https://github.com/tamnd/any-cli)
framework. Each read operation is declared once and exposed three ways: as a CLI
subcommand, over HTTP (`csdn serve`), and over MCP (`csdn mcp`).
